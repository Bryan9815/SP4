...
public class HUD : MonoBehaviour
{
	...
	void Update () 
	{
        if(!ImageSet)
        {
            ...
            //currMP = maxMP = Hero.GetComponent<HeroHolder>().Get_GameObject().GetComponent<Hero>().Get_Mp();
        ...
        //curr<P = Hero.GetComponent<HeroHolder>().Get_GameObject().GetComponent<Hero>().Get_Mp();
